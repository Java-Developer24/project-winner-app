          ...
          {stage === "assembly" && (
            ...
            >
              ...
              {currentWinnerIndex === 0 && (
                <div className="relative w-110 h-110 max-w-2xl mt-4 md:mt-4 mx-auto flex items-center justify-center">
              ...
              {currentWinnerIndex === 1 && (
                <div className="relative w-full aspect-square max-w-4xl mx-auto flex items-center justify-center" style={{minHeight:'460px',height:'460px',maxHeight:'460px'}}>
